...
export const NOTIFICATION_EVENTS = [
  ...
  },
  {
    key: "ncom_order",
    group: "ncom.bd",
    label: "New ncom order",
    desc: "An order was placed on an ncom landing page. Its units are already held against your stock.",
    severity: "info",
    defaultRoles: EVERYONE,
  },
  {
    key: "ncom_hold",
    group: "ncom.bd",
    label: "ncom order held for review",
    desc: "An ncom order failed the courier fraud screen and is waiting on a human decision over there.",
    severity: "warning",
    defaultRoles: ELEVATED,
  },
  {
    key: "ncom_shipment",
    group: "ncom.bd",
    label: "ncom parcel delivered or returned",
    desc: "A parcel for an ncom order reached the customer, or came back.",
    severity: "info",
    defaultRoles: ELEVATED,
  },
  {
    key: "courier_sync",
    group: "Orders",
    label: "Courier sync finished",
    desc: "A delivery-status sync finished and moved orders, or could not run.",
    severity: "info",
    defaultRoles: ELEVATED,
  },
  {
