...
export const PERMISSIONS = {
  ...
  "orders.edit": "Edit order details (items, address, totals)",
  "orders.manage": "Update order & payment status",
  "analytics.view": "View sales analytics & revenue reports",
  ...
  "landing.manage": "Create & manage landing pages",
...
export const PERMISSION_GROUPS = [
  { label: "Orders", keys: ["orders.view", "orders.create", "orders.edit", "orders.manage"] },
  { label: "Reports", keys: ["analytics.view"] },
  { label: "Catalog", keys: ["products.manage", "categories.manage", "discounts.manage"] },
  { label: "Customers", keys: ["customers.view"] },
  { label: "Site", keys: ["content.manage", "landing.manage", "tracking.manage", "settings.manage"] },
