...
import { normalizeSiteInfo, telHref } from "@/lib/siteInfo";
...
export default function Footer() {
  ...
  const { siteName, phone, email, address, social } = normalizeSiteInfo(
    settings?.siteInfo,
              ...
              <ul className="space-y-4 mb-7">
                {address && (
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-[13px] text-white/45 leading-relaxed">{address}</span>
                  </li>
                )}
                {phone && (
                  <li className="flex items-center gap-3">
                    <Phone size={14} className="text-brand-terracotta flex-shrink-0" strokeWidth={1.5} />
                    <a href={telHref(phone)} className="text-[13px] text-white/45 hover:text-white transition-colors">
                      {phone}
                    </a>
                  </li>
                )}
                {email && (
                  <li className="flex items-start gap-3">
                    ...
                    <a href={`mailto:${email}`} className="text-[13px] text-white/45 hover:text-white transition-colors break-all">
                      {email}
                    </a>
                  </li>
                )}
