    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 bg-brand-brown flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-start justify-center px-12 pb-16">
          ...
          <p className="text-brand-cream/50 text-[13px] leading-relaxed max-w-[280px]">
            Join thousands of fashion-forward customers. Exclusive access to new arrivals and member-only offers.
          </p>
          <div className="mt-12 flex items-center gap-3">
            ...
            <span className="text-brand-cream/40 text-[12px] tracking-wide">Order tracking at every step</span>
          </div>
          <div className="mt-3 flex items-center gap-3">
            ...
            <span className="text-brand-cream/40 text-[12px] tracking-wide">Early access to new collections</span>
          </div>
        </div>
      ...
      <div className="w-full lg:w-[55%] xl:w-1/2 bg-brand-cream flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 pt-6 lg:hidden">
          ...
          <Link href="/auth/login" className="text-[11px] uppercase tracking-widest text-brand-tan hover:text-brand-brown transition-colors">
            Sign In
          </Link>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 lg:py-0">
          <div className="w-full max-w-[400px]">
            ...
            <div className="mb-7">
              <p className="text-[11px] uppercase tracking-[3px] text-brand-terracotta mb-2">Get started</p>
              <h1 className="font-display text-[2rem] font-medium text-brand-brown leading-tight">Create your account</h1>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <label className="block text-[10px] uppercase tracking-[2px] text-brand-tan mb-1.5">Full Name</label>
                <input
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-[2px] text-brand-tan mb-1.5">Password</label>
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-[2px] text-brand-tan mb-1.5">Confirm Password</label>
                <div className="relative">
                  <input
              ...
              <p className="text-[11px] text-brand-tan leading-relaxed">
                ...
                <Link href="/privacy" className="text-brand-brown hover:text-brand-terracotta transition-colors">Privacy Policy</Link>.
              </p>

              <button
                type="submit"
                disabled={loading}
                className="w-full bg-brand-brown text-brand-cream py-3.5 text-[11px] uppercase tracking-[3px] font-medium hover:bg-brand-terracotta transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <p className="text-center text-[12px] text-brand-tan mt-7">
              ...
              <Link href="/auth/login" className="text-brand-brown hover:text-brand-terracotta font-medium transition-colors">
                Sign in
              </Link>
            </p>
          </div>
